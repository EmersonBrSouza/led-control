add wave -noupdate -divider {led_nios2_processor: top-level ports}
...
add wave -noupdate -divider {led_nios2_processor: common}
...
add wave -noupdate -divider {led_nios2_processor: breaks}
