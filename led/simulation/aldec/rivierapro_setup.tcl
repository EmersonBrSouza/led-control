...
alias com {
  ...
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                                    
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_xbar_mux                                                                        
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_mux.sv"           -work rsp_xbar_mux                                                                        
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_demux_002.sv"     -work rsp_xbar_demux_002                                                                  
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux_002                                                                    
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_mux_002.sv"       -work cmd_xbar_mux_002                                                                    
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux                                                                        
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                                        
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                                  
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                                      
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_id_router_002.sv"          -work id_router_002                                                                       
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_id_router.sv"              -work id_router                                                                           
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_addr_router_001.sv"        -work addr_router_001                                                                     
  vlog  "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_addr_router.sv"            -work addr_router                                                                         
  ...
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                   -work nios2_processor_instruction_master_translator_avalon_universal_master_0_agent       
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"               -work nios2_processor_jtag_debug_module_translator                                        
  vlog  "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"              -work nios2_processor_instruction_master_translator                                       
  ...
  vlog  "$QSYS_SIMDIR/submodules/led_irq_mapper.sv"                               -work irq_mapper                                                                          
...
alias elab {
  echo "\[exec\] elab"
  eval vsim +access +r -t ps $ELAB_OPTIONS -L work -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L cmd_xbar_mux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_processor_instruction_master_translator_avalon_universal_master_0_agent -L nios2_processor_jtag_debug_module_translator -L nios2_processor_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L output_y -L button_1 -L onchip_memory2_0 -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -dbg -O2 +access +r -t ps $ELAB_OPTIONS -L work -L rsp_xbar_mux_001 -L rsp_xbar_mux -L rsp_xbar_demux_002 -L cmd_xbar_mux_002 -L cmd_xbar_mux -L cmd_xbar_demux_001 -L cmd_xbar_demux -L id_router_002 -L id_router -L addr_router_001 -L addr_router -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent_rsp_fifo -L nios2_processor_jtag_debug_module_translator_avalon_universal_slave_0_agent -L nios2_processor_instruction_master_translator_avalon_universal_master_0_agent -L nios2_processor_jtag_debug_module_translator -L nios2_processor_instruction_master_translator -L rst_controller -L irq_mapper -L mm_interconnect_0 -L output_y -L button_1 -L onchip_memory2_0 -L nios2_processor -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneiv_hssi_ver -L cycloneiv_pcie_hip_ver -L cycloneiv_ver $TOP_LEVEL_NAME
}
