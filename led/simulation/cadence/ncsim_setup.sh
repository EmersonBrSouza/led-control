...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_mux_001.sv"       -work rsp_xbar_mux_001                                                                     -cdslib ./cds_libs/rsp_xbar_mux_001.cds.lib                                                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work rsp_xbar_mux                                                                         -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_mux.sv"           -work rsp_xbar_mux                                                                         -cdslib ./cds_libs/rsp_xbar_mux.cds.lib                                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_rsp_xbar_demux_002.sv"     -work rsp_xbar_demux_002                                                                   -cdslib ./cds_libs/rsp_xbar_demux_002.cds.lib                                                                  
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_mux_002.sv"       -work cmd_xbar_mux_002                                                                     -cdslib ./cds_libs/cmd_xbar_mux_002.cds.lib                                                                    
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                     -work cmd_xbar_mux                                                                         -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_mux.sv"           -work cmd_xbar_mux                                                                         -cdslib ./cds_libs/cmd_xbar_mux.cds.lib                                                                        
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_demux_001.sv"     -work cmd_xbar_demux_001                                                                   -cdslib ./cds_libs/cmd_xbar_demux_001.cds.lib                                                                  
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_cmd_xbar_demux.sv"         -work cmd_xbar_demux                                                                       -cdslib ./cds_libs/cmd_xbar_demux.cds.lib                                                                      
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_id_router_002.sv"          -work id_router_002                                                                        -cdslib ./cds_libs/id_router_002.cds.lib                                                                       
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_id_router.sv"              -work id_router                                                                            -cdslib ./cds_libs/id_router.cds.lib                                                                           
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_addr_router_001.sv"        -work addr_router_001                                                                      -cdslib ./cds_libs/addr_router_001.cds.lib                                                                     
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_mm_interconnect_0_addr_router.sv"            -work addr_router                                                                          -cdslib ./cds_libs/addr_router.cds.lib                                                                         
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_agent.sv"                   -work nios2_processor_instruction_master_translator_avalon_universal_master_0_agent        -cdslib ./cds_libs/nios2_processor_instruction_master_translator_avalon_universal_master_0_agent.cds.lib       
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/altera_merlin_master_translator.sv"              -work nios2_processor_instruction_master_translator                                        -cdslib ./cds_libs/nios2_processor_instruction_master_translator.cds.lib                                       
  ...
  ncvlog -sv "$QSYS_SIMDIR/submodules/led_irq_mapper.sv"                               -work irq_mapper                                                                           -cdslib ./cds_libs/irq_mapper.cds.lib                                                                          
  ncvlog     "$QSYS_SIMDIR/submodules/led_mm_interconnect_0.v"                         -work mm_interconnect_0                                                                    -cdslib ./cds_libs/mm_interconnect_0.cds.lib                                                                   
  ncvlog     "$QSYS_SIMDIR/submodules/led_output_y.v"                                  -work output_y                                                                             -cdslib ./cds_libs/output_y.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/led_button_1.v"                                  -work button_1                                                                             -cdslib ./cds_libs/button_1.cds.lib                                                                            
  ncvlog     "$QSYS_SIMDIR/submodules/led_onchip_memory2_0.v"                          -work onchip_memory2_0                                                                     -cdslib ./cds_libs/onchip_memory2_0.cds.lib                                                                    
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor.v"                           -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor_jtag_debug_module_sysclk.v"  -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor_jtag_debug_module_tck.v"     -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor_jtag_debug_module_wrapper.v" -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor_oci_test_bench.v"            -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/submodules/led_nios2_processor_test_bench.v"                -work nios2_processor                                                                      -cdslib ./cds_libs/nios2_processor.cds.lib                                                                     
  ncvlog     "$QSYS_SIMDIR/led.v"                                                                                                                                                                                                                                                                
fi
